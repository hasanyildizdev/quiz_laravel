...
const audio = new Audio('https://sehriziyafet.iyiapp.com/musics/music.mp3');
const correct = new Audio('https://sehriziyafet.iyiapp.com/musics/true.mp3');
const wrong = new Audio('https://sehriziyafet.iyiapp.com/musics/wrong.mp3');
const time_up = new Audio('https://sehriziyafet.iyiapp.com/musics/time_up.mp3');
...
export default class Game extends Component {
  ...
  constructor(props) {
    ...
    this.playTimeUp = this.playTimeUp.bind(this);
    this.closeSound = this.closeSound.bind(this);
  ...
  componentWillUnmount() {
    ...
    wrong.currentTime = 0;
    time_up.currentTime = 0;
    clearTimeout(this.state.timeout_1);
    clearTimeout(this.state.timeout_2);
  }
  ...
  answered(answer) {
    ...
    this.setState({timeout_2: timeout2});
  }
      ...
      <>
        ...
        <div className="bg flex items-center">
          <div className='w-full h-full pb-24'>
            ...
            {/* SOUND ON OFF BUTTON */}
            <div onClick={this.mute} className=' absolute right-1 top-2 hover:scale-105 cursor-pointer'>
