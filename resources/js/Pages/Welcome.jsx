                    ...
                    <div className='w-full h-full pb-24'>
                        ...
                        <div className='text purpleStyle'>
                            <p className='py-2'>
                               ...
                               در کانال تلگرام ثبت نام کنید و از اعلام بهترین بازیکنان و جوایز آگاه باشید
                            </p>
                        </div>
                            ...
                            <table className="w-full mb-12 mb-12 md:mb-16 lg:mb-18">
                                <thead>
                                    <tr className="text-white text-center">
                                        ...
                                        <th className="px-6 py-3 text-left text-lg font-medium uppercase tracking-wider">آیدی کاربر</th>
                                        <th className="px-6 py-3 text-left text-lg font-medium uppercase tracking-wider">امتیاز</th>
                                    </tr>
                                </thead>
                        ...
                        <div className={`purpleStyle alert ${showGuideAlert ? 'show' : ''}`}>
                            ...
                            <p>
                                ...
                                4 - منتظر اعلام زمان قرعه کشی برترین کاربر ها باش برای دریافت جایزه!
                            </p>
                            <button className='alertSubButton' onClick={handleGuideAlertClick}>فهمیدم!</button>
                        </div>
                        ...
                        <div className={`purpleStyle alert ${showShareAlert ? 'show' : ''}`}>
                            ...
                            <button className='alertSubButton' onClick={handleShareAlertClick}>فهمیدم!</button>
                        </div>
