...
export default function Ad(props) {
    ...
    return (
        <AuthenticatedLayout
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl leading-tight">Advertisment</h2>}
            >
            <div className='admin_bg'>
                <div className='flex justify-center mt-10'>
                    <div className=' bg-gray-500 w-1/3 py-4 rounded-lg text-white'>
                        <h3 className='pb-4 flex justify-center text-white' style={{color:'#fff'}}>Advertisement</h3>
